...
# Timing Attack formula
class TA_Almost_Unsat_Property:
    ...
    def double(self):
        ...
        return TA_Almost_Unsat_Property(self.property, state_quant, compare_state, minimizing)
    ...
    def meets_op(self, a, b):
        return not TA_Almost_Unsat_Property.above_float_precision(a, b) or self.op(a, b)
    ...
    def parse_specification(cls, prism):
        fs = TA_Almost_Unsat_Property.string_formulae()
        properties = []
        i = 0
        disjoint_indexes = []
        for f in fs:
            ...
            p = ps[0]
            p0_min = TA_Almost_Unsat_Property(p, 0, 1, minimizing=True)
            p1_min = TA_Almost_Unsat_Property(p, 1, 0, minimizing=True)
