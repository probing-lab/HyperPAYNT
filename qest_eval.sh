...
# HyperProb commands
cd $hyperprob_dir
hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/PW_4_variant/password_leakage8.nm -hyperString \"AS sh . A s1 . A s2 . ~((start0(s1) & start1(s2)) & ~((P(F counter0(s1)) = P(F counter0(s2))) & ((P(F counter1(s1)) = P(F counter1(s2))) & ((P(F counter2(s1)) = P(F counter2(s2))) & ((P(F counter3(s1)) = P(F counter3(s2))) & ((P(F counter4(s1)) = P(F counter4(s2))) & ((P(F counter5(s1)) = P(F counter5(s2))) & ((P(F counter6(s1)) = P(F counter6(s2))) & ((P(F counter7(s1)) = P(F counter8(s2))) & (P(F counter8(s1)) = P(F counter8(s2))))))))))))\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}

hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/PW_4/password_leakage8.nm -hyperString \"AS sh . A s1 . A s2 . ((start0(s1) & start1(s2)) -> (P(F counter0(s1)) = P(F counter0(s2))))\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}

hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/TA_4_variant/timing_attack8.nm -hyperString \"AS sh . A s1 . A s2 . ~((start0(s1) & start1(s2)) & ~((P(F counter0(s1)) = P(F counter0(s2))) & ((P(F counter1(s1)) = P(F counter1(s2))) & ((P(F counter2(s1)) = P(F counter2(s2))) & ((P(F counter3(s1)) = P(F counter3(s2))) & ((P(F counter4(s1)) = P(F counter4(s2))) & ((P(F counter5(s1)) = P(F counter5(s2))) & ((P(F counter6(s1)) = P(F counter6(s2)))  & ((P(F counter7(s1)) = P(F counter7(s2))) & (P(F counter8(s1)) = P(F counter8(s2))))))))))))\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}

hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/TA_4/timing_attack8.nm -hyperString \"AS sh . A s1 . A s2 . ((start0(s1) & start1(s2)) -> (P(F counter0(s1)) = P(F counter0(s2))))\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}

hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/TS_10.20/thread_scheduler10_20.nm -hyperString \"AS sh . A s1 . A s2 . ~((h1(s1) & h2(s2)) & ~((P(F l1(s1)) = P(F l1(s2))) & (P(F l2(s1)) = P(F l2(s2)))))\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}

hyperprob_call="python hyperprob.py -modelPath benchmark_files/mdp/PC_4/synthesis0_1_2_3_4.nm -hyperString \"ES sh . A s1 . E s2 . ~((start1(s1) & start2(s2)) & ~((P(F die1(s1)) = P(F die1(s2))) & ((P(F die2(s1)) = P(F die2(s2))) & ((P(F die3(s1)) = P(F die3(s2))) & ((P(F die4(s1)) = P(F die4(s2))) & ((P(F die5(s1)) = P(F die5(s2))) & (P(F die6(s1)) = P(F die6(s2))) ) ) ) ) ) )\""
echo \$ ${hyperprob_call}
echo \$ ${hyperprob_call} >> ${log_file_hyperprob}
eval timeout ${timeout} ${hyperprob_call} >> ${log_file_hyperprob}
...
# HyperProb commands
cd $hyperprob_dir
hyperprob_call1="python hyperprob.py -modelPath benchmark_files/mdp/simple/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call1}
echo \$ ${hyperprob_call1} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call1} >> ${log_file_hyperprob_sd}

hyperprob_call2="python hyperprob.py -modelPath benchmark_files/mdp/larger-1/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call2}
echo \$ ${hyperprob_call2} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call2} >> ${log_file_hyperprob_sd}

hyperprob_call3="python hyperprob.py -modelPath benchmark_files/mdp/larger-2/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call3}
echo \$ ${hyperprob_call3} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call3} >> ${log_file_hyperprob_sd}

hyperprob_call4="python hyperprob.py -modelPath benchmark_files/mdp/larger-3/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call4}
echo \$ ${hyperprob_call4} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call4} >> ${log_file_hyperprob_sd}

hyperprob_call5="python hyperprob.py -modelPath benchmark_files/mdp/splash-1/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call5}
echo \$ ${hyperprob_call5} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call5} >> ${log_file_hyperprob_sd}

hyperprob_call6="python hyperprob.py -modelPath benchmark_files/mdp/splash-2/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
echo \$ ${hyperprob_call6}
echo \$ ${hyperprob_call6} >> ${log_file_hyperprob_sd}
eval timeout ${timeout} ${hyperprob_call6} >> ${log_file_hyperprob_sd}

hyperprob_call7="python hyperprob.py -modelPath benchmark_files/mdp/train/maze.nm -hyperString \"ES sh . A s1 . A s2 . ~((start1(s2) & start0(s1)) & ~(P(F target(s2)) < P(F target(s1))))\""
